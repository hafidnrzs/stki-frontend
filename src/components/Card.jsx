const Card = ({ id, title, image, summary }) => {
  return (
    <>
      <div
        id={id}
        className="card w-44 sm:w-60 md:w-72 lg:w-60 xl:w-72 2xl:w-1/4 shadow-xl rounded-2xl bg-white md:bg-green-600 lg:bg-red-500 xl:bg-blue-500 transition-all duration-300"
        data-aos="fade-up"
